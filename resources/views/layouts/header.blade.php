<div class="layout__row layout__row_services">
    <div id="TMpanel">
        <div class="container">
            ...
            <div class="bmenu">
                <a class="bmenu__conversion" href="https://habr.com/sandbox/start/"
                    onclick="if (typeof ga === 'function') { ga('send', 'event', 'habr_top_panel', 'become_an_author'); }">
                    Как стать автором
                </a>

                <a class="bmenu__theme" href="/ru/company/habr/blog/485970/"
                    onclick="if (typeof ga === 'function') { ga('send', 'event', 'habr_top_panel', 'lightning', 'interview'); }">
                    <div class="rec-button-animation">
                    </div>
                    Лучшие интервью
                </a>
            </div>
            ...
            <div class="bmenu_inner" style="display:flex!important;visibility:visible!important;">
                ...
                <span class="bmenu slink">
                    <a href="https://u.tmtm.ru/u-ts-p-101219" target="_blank" style="color: #31B007"
                        rel=" noopener">Умные столы (итоги конкурса)</a>
                    <a href="https://u.tmtm.ru/fintech_chrv" target="_blank" style="color: #AFE4FF"
                        rel=" noopener">Финтех-тест</a>
                    <a href="https://u.tmtm.ru/The_thing_at_top" target="_blank" style="color: #F3FFB5"
                        rel=" noopener">Среди вечных льдов</a>
                </span>
            </div>
        ...
        <div class="main-navbar">
            <div class="main-navbar__section main-navbar__section_left">
                <ul class="nav-links" id="navbar-links">
                    ...
                    <li class="nav-links__item">
                        <a href="https://habr.com/ru/flows/geektimes/" class="nav-links__item-link ">Гиктаймс</a>
                    </li>
                    <li class="nav-links__item">
                        <a href="https://habr.com/ru/flows/misc/" class="nav-links__item-link ">Разное</a>
                    </li>
                </ul>
            ...
            <div class="main-navbar__section main-navbar__section_right">
                <button type="button" class="btn btn_medium btn_navbar_lang js-show_lang_settings">
                    <svg class="icon-svg" width="18" height="18">
                        <use xlink:href="https://habr.com/images/1580818753/common-svg-sprite.svg#globus" />
                    </svg>
                </button>
                <a href="https://habr.com/ru/auth/login/" id="login" class="btn btn_medium btn_navbar_login">Войти</a>
                <a href="https://habr.com/ru/auth/register/"
                    class="btn btn_medium btn_navbar_registration">Регистрация</a>
            </div>
        </div>
    </div>
</div>